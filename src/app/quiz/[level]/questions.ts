...
export const quizLevels: QuizLevel[] = [
  {
    ...
    options: ['GLSL', 'WGSL', 'Metal', 'I don’t know'],
    answer: 2,
    difficulty: 'easy',
  },
  {
    question: 'Which of the following is a basic shader type in WGSL?',
    options: ['Geometry Shader', 'Fragment Shader', 'Turing Shader', 'Blending Shader', 'I don’t know'],
    answer: 1,
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    options: ['vec4', 'float4', 'f32x4', 'vec4f', 'I don’t know'],
    answer: 3,
    difficulty: 'medium',
  },
  {
